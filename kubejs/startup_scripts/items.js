StartupEvents.registry('item', event =>{
	...
	event
	  .create('avaritia:quantum_alloy')
	  .displayName("Quantum Alloy singularity");

	  event
	  .create('avaritia:replica_ingot')
	  .displayName("Replica singularity");
...
event.create('demon_ingot').displayName('Lingote Demonico')
...
event.create('lunar_reactive').displayName('Reactivo Lunar')
