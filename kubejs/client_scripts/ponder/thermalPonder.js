Ponder.registry((event) => {
    /**
     * Scene for the Thermal Machines
     * This scene shows the basic functionality of a Thermal machine.
     */
    event.create(["#thermal:machines"])
        .scene(
            "thermal_tech",
            "Electric Machines",
            "kubejs:thermalponder1",
            (scene, util) => {
                scene.showBasePlate()
                scene.idle(20)
    ...
    /**
     * Scene for the Arboreal Extractor
     * This scene shows how to use the Extractor for tree fluids.
     */
    event.create(["thermal:device_tree_extractor"])
        .scene(
            "thermal_extrr",
            "Extractor",
            "kubejs:thermalponder2",
            (scene, util) => {
                scene.showStructure()
                scene.idle(20)
...
// Registra la etiqueta de Ponder para las máquinas térmicas
Ponder.tags((event) => {
    event.createTag(
        "kubejs:thermal",
        ...
        "Electric Machines",
        "Electric Machines",
        "thermal:machine_furnace", // El archivo de la estructura del tag
        [
            "thermal:machine_furnace",
