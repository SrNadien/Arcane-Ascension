...
//allthemodium
addSifting('xycraft_world:kivi_bricks_cloud_light', IronMesh, 'allthemodium:raw_allthemodium', 1, 0.5)
addSifting('xycraft_world:kivi_bricks_cloud_light', GoldMesh, 'allthemodium:raw_allthemodium', 1, 0.5)
addSifting('xycraft_world:kivi_bricks_cloud_light', DiamondMesh, 'allthemodium:raw_allthemodium', 1, 0.5)
addSifting('xycraft_world:kivi_bricks_cloud_light', NetheriteMesh, 'allthemodium:raw_allthemodium', 1, 0.5)
addSifting('xycraft_world:kivi_bricks_cloud_green', IronMesh, 'allthemodium:raw_vibranium', 1, 0.3)
addSifting('xycraft_world:kivi_bricks_cloud_green', GoldMesh, 'allthemodium:raw_vibranium', 1, 0.3)
addSifting('xycraft_world:kivi_bricks_cloud_green', DiamondMesh, 'allthemodium:raw_vibranium', 1, 0.3)
addSifting('xycraft_world:kivi_bricks_cloud_green', NetheriteMesh, 'allthemodium:raw_vibranium', 1, 0.3)
addSifting('xycraft_world:kivi_bricks_cloud_red', IronMesh, 'allthemodium:raw_unobtainium', 1, 0.1)
addSifting('xycraft_world:kivi_bricks_cloud_red', GoldMesh, 'allthemodium:raw_unobtainium', 1, 0.1)
addSifting('xycraft_world:kivi_bricks_cloud_red', DiamondMesh, 'allthemodium:raw_unobtainium', 1, 0.1)
addSifting('xycraft_world:kivi_bricks_cloud_red', NetheriteMesh, 'allthemodium:raw_unobtainium', 1, 0.1)
