...
ServerEvents.recipes(nadien => {
  ...
  nadien
    ...
    }).id("nadien_tweaks:powah/energizing/energized_steel_block");
  ...
  nadien.custom({
    ...
    }).id("nadien_tweaks:powah/energizing/blaze_block");
  ...
  nadien.custom({
    ...
    }).id("nadien_tweaks:powah/energizing/niotic_block");
  ...
  nadien.custom({
    ...
    }).id("nadien_tweaks:powah/energizing/spirited_block");
    ...
    }).id("nadien_tweaks:powah/dielectriccassing");
    ...
    }).id("nadien_tweaks:powah/dielectricpaste");
    ...
    }).id("nadien_tweaks:powah/dielectricrod");
   ...
   //dielctric rod horizontal
    ...
    }).id("nadien_tweaks:powah/dielectricrodhorizontal");
    ...
    }).id("nadien_tweaks:powah/dielectricrodalt");
    ...
    }).id("nadien_tweaks:powah/dielectricrodaltalt");
});
