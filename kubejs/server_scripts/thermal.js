...
nadien.recipes.thermal.press('kubejs:steel_rod', ['thermal:steel_ingot', 'thermal:chiller_rod_cast']).energy(2400)
 ...
 //induction smelter
 nadien.recipes.thermal.smelter('thermal:steel_ingot', ['minecraft:iron_ingot', 'minecraft:coal']).energy(4800).id('nadien_tweaks:steelingot')
 nadien.recipes.thermal.smelter('thermal:steel_block', ['minecraft:iron_block', 'minecraft:coal_block']).energy(4800).id('nadien_tweaks:steelblock')
 nadien.recipes.thermal.smelter('kubejs:lingotedeacero', ['minecraft:iron_ingot', 'minecraft:charcoal']).energy(4800).id('nadien_tweaks:steelingotdos')
 nadien.recipes.thermal.smelter('ultimate_utilities:hierro_pulsante', ['minecraft:iron_ingot', 'minecraft:ender_pearl']).energy(4800).id('nadien_tweaks:herropulsante')
 nadien.recipes.thermal.smelter('ultimate_utilities:redstone_alloy', ['minecraft:redstone', '#forge:silicon']).energy(4800).id('nadien_tweaks:redstonealloy')
 nadien.recipes.thermal.smelter('ultimate_utilities:hierro_conductor', ['minecraft:iron_ingot', 'minecraft:redstone']).energy(4800).id('nadien_tweaks:hierrocondustor')
 nadien.recipes.thermal.smelter('ultimate_utilities:energetic_alloy', ['minecraft:redstone', 'minecraft:glowstone_dust', 'minecraft:gold_ingot']).energy(4800).id('nadien_tweaks:aleacionenergetica')
 nadien.recipes.thermal.smelter('ultimate_utilities:soularium', ['minecraft:gold_ingot', 'minecraft:soul_sand']).energy(4800).id('nadien_tweaks:aleaciondealmas')
 nadien.recipes.thermal.smelter('ultimate_utilities:vibrant_alloy', ['ultimate_utilities:energetic_alloy', 'minecraft:ender_pearl']).energy(4800).id('nadien_tweaks:alaecionvibrante')
 nadien.recipes.thermal.smelter('ultimate_utilities:melodic_alloy', ['ultimate_utilities:end_steel_alloy', 'minecraft:popped_chorus_fruit']).energy(4800).id('nadien_tweaks:melodicalloy')
 nadien.recipes.thermal.smelter('ultimate_utilities:end_steel_alloy', ['minecraft:end_stone', 'ultimate_utilities:dark_steel', 'minecraft:obsidian']).energy(4800).id('nadien_tweaks:endsteelalloy')
 nadien.recipes.thermal.smelter('ultimate_utilities:dark_steel', ['minecraft:iron_ingot','#forge:dusts/coal', 'minecraft:obsidian']).energy(4800).id('nadien_tweaks:darksteelalloy')
 nadien.recipes.thermal.smelter('ultimate_utilities:stellar_alloy', ['minecraft:nether_star', 'ultimate_utilities:melodic_alloy', '4x minecraft:clay_ball']).energy(4800).id('nadien_tweaks:stellaralloy')
 nadien.recipes.thermal.smelter('ultimate_utilities:enderium_base', ['2x thermal:tin_ingot', 'thermal:lead_ingot', 'alltheores:platinum_ingot']).energy(4800).id('nadien_tweaks:enderiumbase')
  nadien.recipes.thermal.smelter('ultimate_utilities:enderium_base', ['2x #forge:ingots/tin', 'thermal:lead_ingot', '#forge:ingots/platinum']).energy(4800).id('nadien_tweaks:enderiumbasedoos')
 nadien.recipes.thermal.smelter('#forge:ingots/enderium', ['2x ultimate_utilities:enderium_base', 'thermal:basalz_powder', '2x minecraft:ender_pearl']).energy(4800).id('nadien_tweaks:enderiumingot')
 nadien.recipes.thermal.smelter('thermal:enderium_ingot', ['2x ultimate_utilities:enderium_base', '2x create:zinc_ingot', '2x minecraft:ender_pearl']).energy(4800).id('nadien_tweaks:enderiumingotdoos')


 nadien.recipes.thermal.pulverizer('occultism:crushed_end_stone', 'minecraft:end_stone').energy(4800).id('nadien_tweaks:crushedendstonethermal')
 ...
 nadien.custom({
     ...
     "energy": 120000
   }).id('nadien_tweaks:moltendragonsteel')
 ...
 nadien.custom({
   ...
   "result": [
     {
       "item": 'ultimate_utiilities:cacota',
       "count": 1
     }
   ],
   "energy": 120000
 }).id('nadien_tweaks:poop')
...
}).id('nadien_tweaks:netheriteplate')
...
//   }
// }).id('nadien_tweaks:cientmultiplier')
    ...
    }).id('nadien_tweaks:extra_to_endergy')
