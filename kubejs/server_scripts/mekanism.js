...
}).id('nadien_tweaks:instalador_basico_aalt')
...
//instalador avanzado
  ...
  H: 'mekanism:advanced_control_circuit',
  P: 'mekanism:alloy_infused'
}).id('nadien_tweaks:instalador_avanzado_aalt')
...
}).id('nadien_tweaks:instalador_elite_aalt')
...
}).id('nadien_tweaks:minerodigital')
...
}).id('nadien_tweaks:attomicdisasembler')

//chemical infuser
nadien.custom({"type":"mekanism:mek_data","key":{"A":{"tag":"mekanism:alloys/infused"},"C":{"tag":"forge:circuits/basic"},"T":{"item":"mekanism:basic_chemical_tank"},"X":{"item":"mekanism:steel_casing"}},"pattern":["ACA","TXT","ACA"],"result":{"item":"mekanism:chemical_infuser"}}).id('nadien_tweaks:infusorquimico')


//carcasa reactor de fusion
nadien.custom({"type":"minecraft:crafting_shaped","key":{"#":{"tag":"forge:pellets/polonium"},"A":{"tag":"forge:alloys/ultimate"},"X":{"item":"mekanism:steel_casing"}},"pattern":["A#A","#X#","A#A"],"result":{"count":4,"item":"mekanismgenerators:fusion_reactor_frame"}}).id('nadien_tweaks:carcasareactorfision')



//trituradora receta
nadien.custom({"type":"minecraft:crafting_shaped","key":{"B":{"item":"minecraft:lava_bucket"},"C":{"tag":"forge:circuits/basic"},"R":{"tag":"forge:dusts/redstone"},"X":{"item":"mekanism:steel_casing"}},"pattern":["RCR","BXB","RCR"],"result":{"item":"mekanism:crusher"}}).id('nadien_tweaks:trituradora')


//carcasa reactor de fission
nadien.custom({"type":"minecraft:crafting_shaped","key":{"I":{"tag":"forge:ingots/lead"},"X":{"item":"mekanism:steel_casing"}},"pattern":[" I ","IXI"," I "],"result":{"count":4,"item":"mekanismgenerators:fission_reactor_casing"}}).id('nadien_tweaks:carcasareactofission')


//camara de disolucion quimica
nadien.custom({"type":"mekanism:mek_data","key":{"C":{"tag":"forge:circuits/ultimate"},"I":{"tag":"forge:ingots/refined_obsidian"},"T":{"item":"mekanism:basic_chemical_tank"},"X":{"item":"mekanism:steel_casing"}},"pattern":["ITI","CXC","ITI"],"result":{"item":"mekanism:chemical_dissolution_chamber"}}).id('nadien_tweaks:camaradedisolucion')


//generador de gas
nadien.custom({"type":"minecraft:crafting_shaped","key":{"A":{"tag":"mekanism:alloys/infused"},"C":{"item":"mekanism:electrolytic_core"},"O":{"tag":"forge:ingots/osmium"},"X":{"item":"mekanism:steel_casing"}},"pattern":["OAO","XCX","OAO"],"result":{"item":"mekanismgenerators:gas_burning_generator"}}).id('nadien_tweaks:generadordegas')


//Lavadora quimica
nadien.custom({"type":"mekanism:mek_data","key":{"B":{"item":"mekanism:basic_fluid_tank"},"C":{"tag":"forge:circuits/ultimate"},"I":{"tag":"forge:ingots/refined_obsidian"},"T":{"item":"mekanism:basic_chemical_tank"},"X":{"item":"mekanism:steel_casing"}},"pattern":["IBI","CXC","ITI"],"result":{"item":"mekanism:chemical_washer"}}).id('nadien_tweaks:lavarropas')


//calentador resistente
nadien.custom({"type":"mekanism:mek_data","key":{"E":{"item":"mekanism:energy_tablet"},"I":{"tag":"forge:ingots/tin"},"R":{"tag":"forge:dusts/redstone"},"X":{"item":"mekanism:steel_casing"}},"pattern":["IRI","RXR","IEI"],"result":{"item":"mekanism:resistive_heater"}}).id('nadien_tweaks:hornoalena')


//laser
nadien.custom({"type":"mekanism:mek_data","key":{"#":{"tag":"forge:gems/diamond"},"A":{"tag":"mekanism:alloys/reinforced"},"E":{"item":"mekanism:energy_tablet"},"X":{"item":"mekanism:steel_casing"}},"pattern":["AE ","AX#","AE "],"result":{"item":"mekanism:laser"}}).id('nadien_tweaks:laserxd')



//qio drive array
nadien.custom({"type":"mekanism:mek_data","key":{"#":{"item":'expandedstorage:old_netherite_chest'},"C":{"tag":"forge:circuits/ultimate"},"G":{"tag":"forge:glass_panes"},"I":{"tag":"forge:pellets/polonium"},"T":{"item":"mekanism:teleportation_core"}},"pattern":["IGI","C#C","ITI"],"result":{"item":"mekanism:qio_drive_array"}}).id('nadien_tweaks:qio')
...
//Infusor Metalurgico
nadien.custom({"type":"mekanism:metallurgic_infusing","chemicalInput":{"amount":20,"tag":"mekanism:redstone"},"itemInput":{"ingredient":{"tag":"forge:plates/steel"}},"output":{"count":2,"item":"mekanism:alloy_infused"}}).id('nadien_tweaks:aleacioninfusionada')
nadien.custom({"type":"mekanism:metallurgic_infusing","chemicalInput":{"amount":40,"tag":"mekanism:redstone"},"itemInput":{"ingredient":{"tag":"forge:plates/osmium"}},"output":{"count":4,"item":"mekanism:basic_control_circuit"}}).id('nadien_tweaks:circuitobasico')

//combinador
nadien.custom({"type":"mekanism:combining","extraInput":{"ingredient":{"item":"minecraft:wither_skeleton_skull"}},"mainInput":{"ingredient":{"item":"minecraft:compass"}},"output":{"item":"hostilenetworks:prediction_matrix"}}).id('nadien_tweaks:predictionmatrix')
nadien.custom({"type":"mekanism:combining","extraInput":{"ingredient":{"item":'immersiveengineering:sawblade'}},"mainInput":{"ingredient":{"item":"ars_nouveau:starbuncle_charm"}},"output":{"item":"minecraft:dragon_breath"}}).id('nadien_tweaks:dragonaliento')
nadien.custom({"type":"mekanism:combining","extraInput":{"ingredient":{"amount":4,"item":'ae2:certus_quartz_dust'}},"mainInput":{"ingredient":{"amount":4,"item":'minecraft:sand'}},"output":{"count":5,"item":'ae2:certus_quartz_crystal'}}).id('nadien_tweaks:certus')
...
nadien.custom({
  ...
  "key": {
    ...
    "J": {
      "item": "mysticalagriculture:health_boost_vi_augment"
    },
    "K": {
...
nadien.replaceInput({id: 'mekanism:pigment_extractor'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:seismic_vibrator'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:laser'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:chemical_crystallizer'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:pigment_mixer'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:nutritional_liquifier'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:formulaic_assemblicator'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:resistive_heater'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:antiprotonic_nucleosynthesizer'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:teleporter'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:modification_station'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:superheating_element'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:energized_smelter'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:chemical_washer'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:solar_neutron_activator'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanismgenerators:gas_burning_generator'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:security_desk'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:osmium_compressor'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:chemical_dissolution_chamber'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:painting_machine'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanismgenerators:fission_reactor_casing'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:fuelwood_heater'}, 'mekanism:steel_casing', 'mekanism:steel_casing')
nadien.replaceInput({id: 'mekanism:chemical_infuser'}, 'mekanism:steel_casing', 'mekanism:steel_casing')



//trituradora
nadien.custom({"type":"mekanism:crushing","input":{"ingredient":{"item":"minecraft:end_stone"}},"output":{"count":2,"item":"occultism:crushed_end_stone"}}).id('nadien_tweaks:crushedendstone')
nadien.custom({"type":"mekanism:crushing","input":{"ingredient":{"item":"evilcraft:dark_gem"}},"output":{"count":4,"item":"evilcraft:dark_gem_crushed"}}).id('nadien_tweaks:crusheddarkgem')
nadien.custom({"type":"mekanism:crushing","input":{"ingredient":{"item":"ae2:fluix_crystal"}},"output":{"count":4,"item":"ae2:fluix_dust"}}).id('nadien_tweaks:fluixdust')
nadien.custom({"type":"mekanism:crushing","input":{"ingredient":{"item":"ae2:certus_quartz_crystal"}},"output":{"count":4,"item":"e2:certus_quartz_dust"}}).id('nadien_tweaks:certusdust')
