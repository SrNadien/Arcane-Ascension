ServerEvents.recipes(nadien => {
    ...
    nadien.shaped("cobblefordays:tier_1", ["RRR", "WGL", "RRR"], {
      ...
      }).id('nadien_tweaks:cobble_gen_tier_1')
    ...
    //coble gen tier 2
     nadien.custom({
      ...
      }).id('nadien_tweaks:cobble_gen_tier_2')
     ...
     //coble gen tier 3
      ...
      }).id('nadien_tweaks:cobble_gen_tier_3')
      ...
      }).id('nadien_tweaks:cobble_gen_tier_4')
      ...
      }).id('nadien_tweaks:cobble_gen_tier_5')
})