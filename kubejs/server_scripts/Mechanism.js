...
//     nadien.recipes.createDeploying( "kubejs:printed_clearance_processor", ["kubejs:printed_clearance_processor", 'kubejs:inscriber_clearance_press']).keepHeldItem(),
//     nadien.recipes.createDeploying("kubejs:printed_clearance_processor",["kubejs:printed_clearance_processor", 'minecraft:redstone']),
//     nadien.recipes.createDeploying("kubejs:printed_clearance_processor", ["kubejs:printed_clearance_processor", "ae2:printed_silicon"]),
...
// ]).transitionalItem("kubejs:printed_clearance_processor").loops(1).id('nadien_tweaks:clearance_proccesor_terminado');
  ...
  nadien.recipes.createSequencedAssembly([ // start the recipe
	 ...
	 nadien.recipes.createSequencedAssembly([ // start the recipe
		...
		nadien.recipes.createDeploying('kubejs:incomplete_calorite_mechanism',['kubejs:incomplete_calorite_mechanism','ae2:fuzzy_card']),
			...
			nadien.recipes.createSequencedAssembly([ // start the recipe
			    ...
			    nadien.recipes.create.filling('kubejs:incomplete_mystical_mechanism', [Fluid.of('enderio:nutrient_distillation', 1000), 'kubejs:copper_mechanism']),
			    nadien.recipes.create.filling('kubejs:incomplete_mystical_mechanism', [Fluid.of('industrialforegoing:pink_slime', 1000), 'ultimate_utilities:nadienite_ingot']),
				nadien.recipes.create.filling('kubejs:incomplete_mystical_mechanism', [Fluid.of('tinkers_thinking:molten_ardite', 1000), 'kubejs:incomplete_mystical_mechanism']),
				nadien.recipes.createDeploying('kubejs:incomplete_mystical_mechanism',['kubejs:incomplete_mystical_mechanism','enchanted:demonic_blood']),
                nadien.recipes.createDeploying('kubejs:incomplete_mystical_mechanism',['kubejs:incomplete_mystical_mechanism','occultism:chalk_purple']),
				nadien.recipes.createDeploying('kubejs:incomplete_mystical_mechanism',['kubejs:incomplete_mystical_mechanism','enchanted:spirit_of_otherwhere']),
				nadien.recipes.createDeploying('kubejs:incomplete_mystical_mechanism',['kubejs:incomplete_mystical_mechanism','botania:pure_daisy']),
				nadien.recipes.createDeploying('kubejs:incomplete_mystical_mechanism',['kubejs:incomplete_mystical_mechanism','ironfurnaces:unobtainium_furnace']),
            ...
            nadien.recipes.createSequencedAssembly([ // start the recipe
				...
				nadien.recipes.createDeploying('kubejs:incomplete_mystical_mechanism',['kubejs:incomplete_mystical_mechanism','botania:pure_daisy']),
				nadien.recipes.createDeploying('kubejs:incomplete_mystical_mechanism',['kubejs:incomplete_mystical_mechanism','ironfurnaces:unobtainium_furnace']),
			]).transitionalItem('kubejs:incomplete_mystical_mechanism').loops(1).id('nadien_tweaks:mysticalmechalt')
   ...
   nadien.recipes.createSequencedAssembly([ // start the recipe
    ...
    nadien.recipes.createSequencedAssembly([
    ...
    ]).transitionalItem('create:incomplete_precision_mechanism').loops(8).id('nadien_tweaks:presicionmechanism');  
     ...
     //steam mechanism
		...
		]).transitionalItem('create_sa:heat_engine').loops(1).id('nadien_tweaks:steam_engine'); 
	...
	nadien.recipes.create.sequenced_assembly([
       ...
       nadien.recipes.createDeploying('create:incomplete_radiant_mechanism', ['create:incomplete_radiant_mechanism', 'ars_nouveau:glyph_summon_steed'])
    ]).transitionalItem('create:incomplete_radiant_mechanism').loops(1).id('nadien_tweaks:heat_engine');  
    ...
    ]).transitionalItem('create:precision_mechanism').loops(1).id('nadien_tweaks:hydraulic_engine'); 
