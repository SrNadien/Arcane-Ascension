ServerEvents.recipes(nadien => {
        ...
        }).id('nadien_tweaks:celdacreativaaedos')
  ...
  "result": {
    ...
    "count": 1
...
}).id('nadien_tweaks:mekanism/creative_energy_cubee')
        ...
        nadien.recipes.create.mechanical_crafting("mekanism:creative_chemical_tank", [
          ...
          R: 'ultimate_utilities:estella_galactica'
        }).id('nadien_tweaks:quimicocreativo')
        ...
        nadien.recipes.create.mechanical_crafting("mekanism:creative_fluid_tank", [
          ...
          S: "avaritia:infinity_catalyst",
          R: 'ultimate_utilities:estella_galactica'
        }).id('nadien_tweaks:fluidtankmeka')
        ...
        nadien.recipes.create.mechanical_crafting("thermal:rf_coil_creative_augment", [
          ...
          }).id('nadien_tweaks:creativesourcejar')
          ...
          }).id('nadien_tweaks:creativeblazecake')
         ...
         //creative motor
          ...
          }).id('nadien_tweaks:creativemotor')
          ...
          nadien.shaped('ars_nouveau:creative_spell_book',  ['BSG', 'GGE', 'EER'],
            ...
            }).id('nadien_tweaks:creativespellbook')
  ...
  //   })
     ...
     //tableta creativa botania
     nadien.recipes.create.mechanical_crafting(Item.of("botania:mana_tablet", "{creative:1b,mana:500000}"), [
        "BAAACAAAD",
        "ATTJKLTTA",
        "ATUVMUUTA",
        "ANUOPOUQA",
    ...
    ],
    {
        ...
        V: 'ultimate_utilities:estella_galactica'
    })

    //pila de culpa perpetua botania
    nadien.recipes.create.mechanical_crafting('botania:creative_pool', [
        "NNNNNNNNN",
        "NXCXYXCXN",
        "NCXEYEXCN",
        "NXEVYEEXN",
