ServerEvents.recipes(nadien => {
  ...
  // ATM-Vibranium Ingot
    ...
    }).id(`nadien_tweaks:energizing/allthemodium_vibranium_allthemodium_alloy_ingot`)
  ...
  // ATM-Vibranium Block
    ...
    }).id(`nadien_tweaks:energizing/allthemodium_vibranium_allthemodium_alloy_block`)
  ...
  // ATM-Unobtainium Ingot
    ...
    }).id(`nadien_tweaks:energizing/allthemodium_unobtainium_allthemodium_alloy_ingot`)
  ...
  // ATM-Unobtainium Block
    ...
    }).id(`nadien_tweaks:energizing/allthemodium_unobtainium_allthemodium_alloy_block`)
  ...
  // Unobtainium-Vibranium Ingot
    ...
    }).id(`nadien_tweaks:energizing/allthemodium_unobtainium_vibranium_alloy_ingot`)
  ...
  }).id(`nadien_tweaks:energizing/allthemodium_ingot`)
  ...
  nadien.custom({
    ...
    "energy": 232000
  }).id(`nadien_tweaks:molten_${ATM_metal}`)
  )
  ATM_metal.forEach(ATM_metal =>
  nadien.custom({
    ...
    "energy": 232000
  }).id(`nadien_tweaks:chilling_${ATM_metal}`) )
...
// nadien.recipes.botania.orechid('alltheores:iridium_ore', 'bloodmagic:blankrune', 1)
// nadien.recipes.botania.orechid('alltheores:deepslate_iridium_ore', 'bloodmagic:blankrune', 2)



// nadien.remove({output: 'bloodmagic:altar'})
// nadien.shaped('bloodmagic:altar', [
//   'a a',
//   'bcb',
//   'ddd'
// ], {
//   a: 'chipped:natural_cherry_planks',
//   b: 'botania:lime_petal_block',
//   c: 'clickmachine:auto_clicker',
//   d: 'kubejs:demon_ingot'
// }).id('nadien_tweaks:blood_altar')
