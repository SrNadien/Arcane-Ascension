...
nadien.custom({"type":"minecraft:crafting_shaped","pattern":["igi","geg","igi"],"key":{"i":{"tag":"forge:sheetmetals/steel"},"e":{"item":'kubejs:demon_ingot'},"g":{"item":"immersiveengineering:component_steel"}},"result":{"item":"immersiveengineering:heavy_engineering","count":2}}).id('nadien_tweaks:heavyengineering')


//bloque de ingieneria pesada
nadien.custom({"type":"minecraft:crafting_shaped","pattern":["igi","gcg","igi"],"key":{"i":{"tag":"forge:sheetmetals/iron"},"c":{"item":'kubejs:demon_ingot'},"g":{"item":"immersiveengineering:component_iron"}},"result":{"item":"immersiveengineering:light_engineering","count":2}}).id('nadien_tweaks:lightengineering')




//dragon steel plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal_extra:dragonsteel_plate'},"conditions":[{"value":{"tag":'forge:ingots/dragonsteel',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/dragonsteel',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/dragonsteel'},"energy":2400}).id('nadien_tweaks:dragonsteelcompatplate')

//twine plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal_extra:twinite_plate'},"conditions":[{"value":{"tag":'forge:ingots/twinite',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/twinite',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/twinite'},"energy":2400}).id('nadien_tweaks:twinecompatplate')

//shellite plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal_extra:shellite_plate'},"conditions":[{"value":{"tag":'forge:ingots/shellite',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/shellite',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/shellite'},"energy":2400}).id('nadien_tweaks:sellitecompatplate')

//soul infused plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal_extra:soul_infused_plate'},"conditions":[{"value":{"tag":'forge:ingots/soul_infused',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/soul_infused',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/soul_infused'},"energy":2400}).id('nadien_tweaks:')

//enderium plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal:enderium_plate'},"conditions":[{"value":{"tag":'forge:ingots/enderium',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/enderium',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/enderium'},"energy":2400}).id('nadien_tweaks:enderiumcompatplate')

//lumium plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal:lumium_plate'},"conditions":[{"value":{"tag":'forge:ingots/lumium',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/lumium',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/lumium'},"energy":2400}).id('nadien_tweaks:lumiumcompatplates')

//signalum plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal:signalum_plate'},"conditions":[{"value":{"tag":'forge:ingots/signalum',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/signalum',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/signalum'},"energy":2400}).id('nadien_tweaks:signalumcompatplate')

//netherite plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'thermal:netherite_plate'},"conditions":[{"value":{"tag":'forge:ingots/netherite',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/netherite',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/netherite'},"energy":2400}).id('nadien_tweaks:netheritecompatplate')

//iridium plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'alltheores:iridium_plate'},"conditions":[{"value":{"tag":'forge:ingots/iridium',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/iridium',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:ingots/iridium'},"energy":2400}).id('nadien_tweaks:iridiumcompatplate')

//diamond plate
nadien.custom({"type":"immersiveengineering:metal_press","mold":"immersiveengineering:mold_plate","result":{"item":'alltheores:diamond_plate'},"conditions":[{"value":{"tag":'forge:gems/diamond',"type":"forge:tag_empty"},"type":"forge:not"},{"value":{"tag":'forge:plates/diamond',"type":"forge:tag_empty"},"type":"forge:not"}],"input":{"tag":'forge:gems/diamond'},"energy":2400}).id('nadien_tweaks:diamondcompatplate')
...
nadien.shaped('immersiveengineering:workbench', [
  ...
  "processingTime": 300
}).id('nadien_tweaks:madera_traata')
  ...
  "processingTime": 300
}).id('nadien_tweaks:madera_traata_alt')
